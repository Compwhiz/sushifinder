...
module.exports = {
  ...
  db: process.env.MONGODB || 'mongodb://admin:admin@proximus.modulusmongo.net:27017/ta5rehyT',
  ...
  google: {
    clientID: process.env.GOOGLE_ID || '211790103120-nlfvpjfs1hnapaduscjvvai8tke6v629.apps.googleusercontent.com',
    clientSecret: process.env.GOOGLE_SECRET || 'u-w58lxMYHXCdIrmeh8_bYp-',
  ...
  yelp: {
    api_host: 'http://api.yelp.com/v2/',
    consumer_key: 'w_7reS4fsxo8onzj4sInHA',
    consumer_secret: 'ijPmezVB5YS2fs50q9tCHZBevaE',
    token: 'PdLS9PoLEicZxc2UOMaeOUN4X7keiJ_t',
    token_secret: 'bMmBV-A7D2ZoA4AX4OOxiEH5lYQ'
  }
};
